    ...
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string specialization = null, int pageNumber = 1, int pageSize = 6)
        {
            ...
            var patient = await _context.Patients
                ...
                .Include(p => p.User) // Dacă vrei și info despre user (ex. nume, email)
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            return View(patient); // Asta trimite modelul către Edit.cshtml
        }
        ...
        public async Task<IActionResult> Edit(PatientModel model)
        {
            ...
            var existing = await _context.Patients.FindAsync(model.id);
            if (existing == null)
                return NotFound();

            existing.age = model.age;
            existing.cnp = model.cnp;
            existing.address_street = model.address_street;
            existing.address_city = model.address_city;
            existing.address_county = model.address_county;
...
*/
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            patient.EcgSignals = await _context.EcgSignal
